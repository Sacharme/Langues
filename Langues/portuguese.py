...
# ============== CONFIGURATION ==============
AUTO_SAVE_THRESHOLD = 100  # Nombre d'essais avant auto-sauvegarde (dictionnaire complet)
...
fichier_sample = os.path.join(BASE_DIR, 'Dictionnaires', 'portuguese_sample.txt')
...
def generate_2d_graph(category):
    ...
    ax.set_title(f'Portuguese Progress - {category_names[category]} (Goal: {goal}%)', fontsize=14)
...
class QuizApp:
    ...
    def generer_question_revision(self):
        ...
        self.bonne_reponse = mots_portugais[word_index]
